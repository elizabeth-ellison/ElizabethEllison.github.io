...
Currently I am a co-investigator on the [CSSP China](https://www.metoffice.gov.uk/research/approach/collaboration/newton/cssp-china/index) project **SWARM** (Impacts Assessment to Support WAter Resources Management and Climate Change Adaptation for China). In this project improved climate projections of the 21st century over East Asia will be downscaled and used to drive a model of glacier evolution to project runoff and glacier loss. It is quite an interesting project given the importance of Asian glaciers to water security in the region. The model we will use is the Open Global Glacier Model ([oggm](https://oggm.org)). oggm is a very powerful code, developed in python, which allows the user to quickly process data and generate simulations for large numbers of glaciers, and the developers are incrediby helpful -- the more I learn about it, the more I like it! 
